...
////////////////////////////////////////////////////////////////////
template<class T>
T extrema_detect<T>::forward_differentiation(T x[], T t[]){return ((x[1]-x[0])/(t[1]-t[0]));};  // first order 
...
T minimum_array[SAMPLE ];
T maximum_array[SAMPLE ];
T minimum_time_array[SAMPLE ];
T maximum_time_array[SAMPLE ];
...
break;
case 1:
minimum.insert(minimum.end(), &extrema_data[0], &extrema_data[size_extrema-1]);
//std::cout<< "minimum, ";
break;
case 2:
