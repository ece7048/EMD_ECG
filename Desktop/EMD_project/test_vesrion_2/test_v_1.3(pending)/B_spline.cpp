...
////////////////////////////////////////////////////////////////////
template<class T>
void B_spline<T>::test_internal(std::vector<T> initial_signal, std::vector<T> &b_spline_min, std::vector<T> &b_spline_max, int loop)
{
T new_value=0;
T value_initial=0;
T value_b_spline_max=0;
T value_b_spline_min=0;
T variance=(increase_value*value_initial)/loop;
