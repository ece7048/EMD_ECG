...
B_spline<T> bs(min, min_time, time_ecg);//call spine constractor
...
B_spline<T> bs2(max, max_time, time_ecg);//call spine constractor
...
bs2.test_internal(h_comp2, spline_min, spline_max, i); //check if internal the initial signal
////////////debug//////////////////////////////////////
// std::cout<<"AFTER,";
//for (unsigned int d=0;d<spline_min.size();++d){
...
//bs2.~B_spline();
// h-compute
bS_l.push_front(spline_min);
bS_l.push_back(spline_max);
compute_components<T> CH(bS_l,h_comp2);
...
c_SD=SCH->get_SD();
////////////debug//////////////////////////////////////
std::cout<<i<<" itteration of IMF define"<<"\n";
std::cout<<"the SD of h is: "<<std::fixed <<c_SD<<"\n";
i++;
//////////////////////////////////////////////////////////////
