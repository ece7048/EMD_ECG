...
var_1=variance_b();
test=test_critirio(var, var_1);
std::transform (estim_b_i.begin(), estim_b_i.end(), b_i.begin(), estim_b_i.begin(), std::plus<T>());//store the sum in the estimated b_i
if (k>=list_size-1){test=true;};
//debug
