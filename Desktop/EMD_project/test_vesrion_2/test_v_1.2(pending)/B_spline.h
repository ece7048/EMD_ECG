...
//function
void test_internal(std::vector<T> initial_signal, std::vector<T> &b_spline_min, std::vector<T> &b_spline_max, int loop);
protected:
...
private:
T S_extrema[N_sample]={0};
T B_time[N_sample]={0};
T timestep[N_sample]={0}; //timestep of intervals of time
T time[N_sample]={0}; 
...
unsigned int c_dim;
unsigned int c_h;
T L[N_sample][N_sample]= {0}; // L component matrix
T U[N_sample][N_sample]= {0}; // U component matrix
T A[N_sample][N_sample]= {0}; // A matrix coefficient
T B[N_sample]= {0}; //B vector
