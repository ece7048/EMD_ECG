...
#define L_data 393  //the number of the data of ECG
#define ECG_data "/home/mamalakis/Desktop/ECG_partwo/experimental_data/filtered.txt" //path of ECG file

// B_spline parameters
#define N_sample 393 //b_spline interpolation namber
...
#define type_interpolation 0 //linear (1), cubic_spline (0)
