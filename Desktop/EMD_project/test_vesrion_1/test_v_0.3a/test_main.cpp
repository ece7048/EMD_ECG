...
xin[i]=2*sin(t[i]*2*M_PI *50)+5*sin(t[i]*2*M_PI *3)+1*sin(t[i]*2*M_PI *10)+2*sin(t[i]*2*M_PI *20)+3*sin(t[i]*2*M_PI *120);
...
////////////debug//////////////////////////////////////
std::cout<<count3<<" the SD of h is: "<<SD2;
//////////////////////////////////////////////////////////////
...
/////////////////////////////////////splines of min-max/////////////////////
 ...
 //gnu << "plot '-' with lines title 'initial signal', '-' with points title 'minimum'\ n";
 ...
 for (unsigned int o=0;o<L_data;++o){
  x[o]=xin[o]-h_comp2_array[o];
  xin[o]=x[o];
  }//end loop

 if(count4==LOOP2){SDs=0.2;};

 count4++;
 count3=0;

}//end _if internal loop
